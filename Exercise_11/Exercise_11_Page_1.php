...
if(isset($_POST['submit']))
	{
		...
		if($regno!="" && $name!="" && $age!="" && $gender!="" && $pwd!="" && $email!="" && $mno!=""){
			...
			if($sql){
				header("refresh:1;url=Exercise_11_page_2.php");
			}
		}
	}
?>
<html>
<head>
<title>Exercise_11_Form Validation_And_Table_Insertion</title>
<link rel="stylesheet" type="text/css" href="Ex_11.css">
